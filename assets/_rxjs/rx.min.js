...
d.status}m(c,a);return c}(Error);f.AjaxError=u;var x=function(a){function c(e,d){a.call(this,"ajax timeout",e,d)}m(c,a);return c}(u);f.AjaxTimeoutError=x},{"../../Observable":5,"../../Subscriber":13,"../../util/errorObject":321,"../../util/root":331,"../../util/tryCatch":335}],171:[function(a,b,f){var h=this&&this.__extends||function(a,c){function e(){this.constructor=a}for(var d in c)c.hasOwnProperty(d)&&(a[d]=c[d]);a.prototype=null===c?Object.create(c):(e.prototype=c.prototype,new e)},k=a("../../Subject"),
l=a("../../Subscriber"),g=a("../../Observable"),d=a("../../Subscription"),c=a("../../util/root"),e=a("../../ReplaySubject"),m=a("../../util/tryCatch"),n=a("../../util/errorObject"),q=a("../../util/assign");a=function(a){function b(d,m){a.call(this);this._output=new k.Subject;this.WebSocketCtor=c.root.WebSocket;"string"===typeof d?this.url=d:q.assign(this,d);if(!this.WebSocketCtor)throw Error("no WebSocket constructor can be found");this.destination=new e.ReplaySubject}h(b,a);b.prototype.resultSelector=
function(a){return JSON.parse(a.data)};b.create=function(a){return new b(a)};b.prototype.lift=function(a){var c=new b(this,this.destination);c.operator=a;return c};b.prototype.multiplex=function(a,c,e){var d=this;return new g.Observable(function(b){var g=m.tryCatch(a)();g===n.errorObject?b.error(n.errorObject.e):d.next(g);var f=d.subscribe(function(a){var c=m.tryCatch(e)(a);c===n.errorObject?b.error(n.errorObject.e):c&&b.next(a)},function(a){return b.error(a)},function(){return b.complete()});return function(){var a=
m.tryCatch(c)();a===n.errorObject?b.error(n.errorObject.e):d.next(a);f.unsubscribe()}})};b.prototype._connectSocket=function(){var a=this,c=this.protocol?new WebSocket(this.url,this.protocol):new WebSocket(this.url);this.socket=c;var b=new d.Subscription(function(){a.socket=null;c&&1===c.readyState&&c.close()}),g=this._output;c.onopen=function(d){var m=a.openObserver;m&&m.next(d);d=a.destination;a.destination=l.Subscriber.create(function(a){return 1===c.readyState&&c.send(a)},function(d){var b=a.closingObserver;
b&&b.next(void 0);d&&d.code?c.close(d.code,d.reason):g.error(new TypeError("WebSocketSubject.error must be called with an object with an error code, and an optional reason: { code: number, reason: string }"));a.destination=new e.ReplaySubject;a.socket=null},function(){var d=a.closingObserver;d&&d.next(void 0);c.close();a.destination=new e.ReplaySubject;a.socket=null});d&&d instanceof e.ReplaySubject&&b.add(d.subscribe(a.destination))};c.onerror=function(a){return g.error(a)};c.onclose=function(c){var e=
a.closeObserver;e&&e.next(c);c.wasClean?g.complete():g.error(c)};c.onmessage=function(c){c=m.tryCatch(a.resultSelector)(c);c===n.errorObject?g.error(n.errorObject.e):g.next(c)}};b.prototype._subscribe=function(a){var c=this;this.socket||this._connectSocket();var e=new d.Subscription;e.add(this._output.subscribe(a));e.add(function(){var a=c.socket;a&&1===a.readyState&&(a.close(),c.socket=null)});return e};b.prototype.unsubscribe=function(){var c=this.socket;c&&1===c.readyState&&(c.close(),this.socket=
null);a.prototype.unsubscribe.call(this);this.destination=new e.ReplaySubject};return b}(k.AnonymousSubject);f.WebSocketSubject=a},{"../../Observable":5,"../../ReplaySubject":9,"../../Subject":11,"../../Subscriber":13,"../../Subscription":14,"../../util/assign":320,"../../util/errorObject":321,"../../util/root":331,"../../util/tryCatch":335}],172:[function(a,b,f){a=a("./AjaxObservable");f.ajax=a.AjaxObservable.create},{"./AjaxObservable":170}],173:[function(a,b,f){a=a("./WebSocketSubject");f.webSocket=
a.WebSocketSubject.create},{"./WebSocketSubject":171}],174:[function(a,b,f){a=a("./EmptyObservable");f.empty=a.EmptyObservable.create},{"./EmptyObservable":147}],175:[function(a,b,f){a=a("./ForkJoinObservable");f.forkJoin=a.ForkJoinObservable.create},{"./ForkJoinObservable":149}],176:[function(a,b,f){a=a("./FromObservable");f.from=a.FromObservable.create},{"./FromObservable":152}],177:[function(a,b,f){a=a("./FromEventObservable");f.fromEvent=a.FromEventObservable.create},{"./FromEventObservable":150}],
178:[function(a,b,f){a=a("./FromEventPatternObservable");f.fromEventPattern=a.FromEventPatternObservable.create},{"./FromEventPatternObservable":151}],179:[function(a,b,f){a=a("./PromiseObservable");f.fromPromise=a.PromiseObservable.create},{"./PromiseObservable":159}],180:[function(a,b,f){a=a("./IfObservable");f._if=a.IfObservable.create},{"./IfObservable":154}],181:[function(a,b,f){a=a("./IntervalObservable");f.interval=a.IntervalObservable.create},{"./IntervalObservable":155}],182:[function(a,
b,f){a=a("../operator/merge");f.merge=a.mergeStatic},{"../operator/merge":236}],183:[function(a,b,f){a=a("./NeverObservable");f.never=a.NeverObservable.create},{"./NeverObservable":158}],184:[function(a,b,f){a=a("./ArrayObservable");f.of=a.ArrayObservable.of},{"./ArrayObservable":142}],185:[function(a,b,f){a=a("./RangeObservable");f.range=a.RangeObservable.create},{"./RangeObservable":160}],186:[function(a,b,f){a=a("./ErrorObservable");f._throw=a.ErrorObservable.create},{"./ErrorObservable":148}],
187:[function(a,b,f){a=a("./TimerObservable");f.timer=a.TimerObservable.create},{"./TimerObservable":163}],188:[function(a,b,f){a=a("./UsingObservable");f.using=a.UsingObservable.create},{"./UsingObservable":164}],189:[function(a,b,f){a=a("../operator/zip");f.zip=a.zipStatic},{"../operator/zip":288}],190:[function(a,b,f){var h=this&&this.__extends||function(a,c){function d(){this.constructor=a}for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b]);a.prototype=null===c?Object.create(c):(d.prototype=c.prototype,
new d)},k=a("../util/tryCatch"),l=a("../util/errorObject");b=a("../OuterSubscriber");var g=a("../util/subscribeToResult");f.audit=function(a){return this.lift(new d(a))};var d=function(){function a(c){this.durationSelector=c}a.prototype.call=function(a,e){return e._subscribe(new c(a,this.durationSelector))};return a}(),c=function(a){function c(d,b){a.call(this,d);this.durationSelector=b;this.hasValue=!1}h(c,a);c.prototype._next=function(a){this.value=a;this.hasValue=!0;this.throttled||(a=k.tryCatch(this.durationSelector)(a),
a===l.errorObject?this.destination.error(l.errorObject.e):this.add(this.throttled=g.subscribeToResult(this,a)))};c.prototype.clearThrottle=function(){var a=this.value,c=this.hasValue,e=this.throttled;e&&(this.remove(e),this.throttled=null,e.unsubscribe());c&&(this.value=null,this.hasValue=!1,this.destination.next(a))};c.prototype.notifyNext=function(a,c,e,d){this.clearThrottle()};c.prototype.notifyComplete=function(){this.clearThrottle()};return c}(b.OuterSubscriber)},{"../OuterSubscriber":8,"../util/errorObject":321,
"../util/subscribeToResult":332,"../util/tryCatch":335}],191:[function(a,b,f){function h(a){a.clearThrottle()}var k=this&&this.__extends||function(a,e){function d(){this.constructor=a}for(var b in e)e.hasOwnProperty(b)&&(a[b]=e[b]);a.prototype=null===e?Object.create(e):(d.prototype=e.prototype,new d)},l=a("../scheduler/async");a=a("../Subscriber");f.auditTime=function(a,e){void 0===e&&(e=l.async);return this.lift(new g(a,e))};var g=function(){function a(c,d){this.duration=c;this.scheduler=d}a.prototype.call=
function(a,c){return c._subscribe(new d(a,this.duration,this.scheduler))};return a}(),d=function(a){function e(e,d,b){a.call(this,e);this.duration=d;this.scheduler=b;this.hasValue=!1}k(e,a);e.prototype._next=function(a){this.value=a;this.hasValue=!0;this.throttled||this.add(this.throttled=this.scheduler.schedule(h,this.duration,this))};e.prototype.clearThrottle=function(){var a=this.value,c=this.hasValue,e=this.throttled;e&&(this.remove(e),this.throttled=null,e.unsubscribe());c&&(this.value=null,
this.hasValue=!1,this.destination.next(a))};return e}(a.Subscriber)},{"../Subscriber":13,"../scheduler/async":301}],192:[function(a,b,f){var h=this&&this.__extends||function(a,c){function e(){this.constructor=a}for(var b in c)c.hasOwnProperty(b)&&(a[b]=c[b]);a.prototype=null===c?Object.create(c):(e.prototype=c.prototype,new e)};b=a("../OuterSubscriber");var k=a("../util/subscribeToResult");f.buffer=function(a){return this.lift(new l(a))};var l=function(){function a(c){this.closingNotifier=c}a.prototype.call=
function(a,e){return e._subscribe(new g(a,this.closingNotifier))};return a}(),g=function(a){function c(c,b){a.call(this,c);this.buffer=[];this.add(k.subscribeToResult(this,b))}h(c,a);c.prototype._next=function(a){this.buffer.push(a)};c.prototype.notifyNext=function(a,c,d,b,g){a=this.buffer;this.buffer=[];this.destination.next(a)};return c}(b.OuterSubscriber)},{"../OuterSubscriber":8,"../util/subscribeToResult":332}],193:[function(a,b,f){var h=this&&this.__extends||function(a,d){function c(){this.constructor=
a}for(var e in d)d.hasOwnProperty(e)&&(a[e]=d[e]);a.prototype=null===d?Object.create(d):(c.prototype=d.prototype,new c)};a=a("../Subscriber");f.bufferCount=function(a,d){void 0===d&&(d=null);return this.lift(new k(a,d))};var k=function(){function a(d,c){this.bufferSize=d;this.startBufferEvery=c}a.prototype.call=function(a,c){return c._subscribe(new l(a,this.bufferSize,this.startBufferEvery))};return a}(),l=function(a){function d(c,e,d){a.call(this,c);this.bufferSize=e;this.startBufferEvery=d;this.buffers=
[[]];this.count=0}h(d,a);d.prototype._next=function(a){var e=this.count+=1,d=this.destination,b=this.bufferSize,g=this.buffers,f=g.length,l=-1;0===e%(null==this.startBufferEvery?b:this.startBufferEvery)&&g.push([]);for(e=0;e<f;e++){var k=g[e];k.push(a);k.length===b&&(l=e,d.next(k))}-1!==l&&g.splice(l,1)};d.prototype._complete=function(){for(var c=this.destination,e=this.buffers;0<e.length;){var d=e.shift();0<d.length&&c.next(d)}a.prototype._complete.call(this)};return d}(a.Subscriber)},{"../Subscriber":13}],
194:[function(a,b,f){function h(a){var c=a.subscriber,e=a.context;e&&c.closeContext(e);a.context=c.openContext();c.isUnsubscribed||(a.context.closeAction=this.schedule(a,a.bufferTimeSpan))}function k(a){var c=a.bufferCreationInterval,e=a.bufferTimeSpan,d=a.subscriber,b=a.scheduler,m=d.openContext();d.isUnsubscribed||(d.add(m.closeAction=b.schedule(l,e,{subscriber:d,context:m})),this.schedule(a,c))}function l(a){a.subscriber.closeContext(a.context)}var g=this&&this.__extends||function(a,c){function e(){this.constructor=
...
function(){var a=new m;this.contexts.push(a);return a};c.prototype.closeContext=function(a){this.destination.next(a.buffer);var c=this.contexts;c.splice(c.indexOf(a),1)};return c}(b.Subscriber)},{"../Subscriber":13,"../scheduler/async":301,"../util/isScheduler":328}],195:[function(a,b,f){var h=this&&this.__extends||function(a,e){function d(){this.constructor=a}for(var b in e)e.hasOwnProperty(b)&&(a[b]=e[b]);a.prototype=null===e?Object.create(e):(d.prototype=e.prototype,new d)},k=a("../Subscription"),
l=a("../util/subscribeToResult");a=a("../OuterSubscriber");f.bufferToggle=function(a,e){return this.lift(new g(a,e))};var g=function(){function a(c,d){this.openings=c;this.closingSelector=d}a.prototype.call=function(a,c){return c._subscribe(new d(a,this.openings,this.closingSelector))};return a}(),d=function(a){function e(e,d,b){a.call(this,e);this.openings=d;this.closingSelector=b;this.contexts=[];this.add(l.subscribeToResult(this,d))}h(e,a);e.prototype._next=function(a){for(var c=this.contexts,
e=c.length,d=0;d<e;d++)c[d].buffer.push(a)};e.prototype._error=function(e){for(var d=this.contexts;0<d.length;){var b=d.shift();b.subscription.unsubscribe();b.buffer=null;b.subscription=null}this.contexts=null;a.prototype._error.call(this,e)};e.prototype._complete=function(){for(var e=this.contexts;0<e.length;){var d=e.shift();this.destination.next(d.buffer);d.subscription.unsubscribe();d.buffer=null;d.subscription=null}this.contexts=null;a.prototype._complete.call(this)};e.prototype.notifyNext=function(a,
c,e,d,b){a?this.closeBuffer(a):this.openBuffer(c)};e.prototype.notifyComplete=function(a){this.closeBuffer(a.context)};e.prototype.openBuffer=function(a){try{var c=this.closingSelector.call(this,a);c&&this.trySubscribe(c)}catch(e){this._error(e)}};e.prototype.closeBuffer=function(a){var c=this.contexts;if(c&&a){var e=a.subscription;this.destination.next(a.buffer);c.splice(c.indexOf(a),1);this.remove(e);e.unsubscribe()}};e.prototype.trySubscribe=function(a){var c=this.contexts,e=new k.Subscription,
d={buffer:[],subscription:e};c.push(d);a=l.subscribeToResult(this,a,d);!a||a.isUnsubscribed?this.closeBuffer(d):(a.context=d,this.add(a),e.add(a))};return e}(a.OuterSubscriber)},{"../OuterSubscriber":8,"../Subscription":14,"../util/subscribeToResult":332}],196:[function(a,b,f){var h=this&&this.__extends||function(a,c){function e(){this.constructor=a}for(var d in c)c.hasOwnProperty(d)&&(a[d]=c[d]);a.prototype=null===c?Object.create(c):(e.prototype=c.prototype,new e)},k=a("../Subscription"),l=a("../util/tryCatch"),
g=a("../util/errorObject");b=a("../OuterSubscriber");var d=a("../util/subscribeToResult");f.bufferWhen=function(a){return this.lift(new c(a))};var c=function(){function a(c){this.closingSelector=c}a.prototype.call=function(a,c){return c._subscribe(new e(a,this.closingSelector))};return a}(),e=function(a){function c(e,d){a.call(this,e);this.closingSelector=d;this.subscribing=!1;this.openBuffer()}h(c,a);c.prototype._next=function(a){this.buffer.push(a)};c.prototype._complete=function(){var c=this.buffer;
c&&this.destination.next(c);a.prototype._complete.call(this)};c.prototype._unsubscribe=function(){this.buffer=null;this.subscribing=!1};c.prototype.notifyNext=function(a,c,e,d,b){this.openBuffer()};c.prototype.notifyComplete=function(){this.subscribing?this.complete():this.openBuffer()};c.prototype.openBuffer=function(){var a=this.closingSubscription;a&&(this.remove(a),a.unsubscribe());(a=this.buffer)&&this.destination.next(a);this.buffer=[];var c=l.tryCatch(this.closingSelector)();c===g.errorObject?
this.error(g.errorObject.e):(this.closingSubscription=a=new k.Subscription,this.add(a),this.subscribing=!0,a.add(d.subscribeToResult(this,c)),this.subscribing=!1)};return c}(b.OuterSubscriber)},{"../OuterSubscriber":8,"../Subscription":14,"../util/errorObject":321,"../util/subscribeToResult":332,"../util/tryCatch":335}],197:[function(a,b,f){var h=a("./publishReplay");f.cache=function(a,b,g){void 0===a&&(a=Number.POSITIVE_INFINITY);void 0===b&&(b=Number.POSITIVE_INFINITY);return h.publishReplay.call(this,
a,b,g).refCount()}},{"./publishReplay":251}],198:[function(a,b,f){var h=this&&this.__extends||function(a,d){function c(){this.constructor=a}for(var e in d)d.hasOwnProperty(e)&&(a[e]=d[e]);a.prototype=null===d?Object.create(d):(c.prototype=d.prototype,new c)};a=a("../Subscriber");f._catch=function(a){a=new k(a);var d=this.lift(a);return a.caught=d};var k=function(){function a(d){this.selector=d}a.prototype.call=function(a,c){return c._subscribe(new l(a,this.selector,this.caught))};return a}(),l=function(a){function d(c,
e,d){a.call(this,c);this.selector=e;this.caught=d}h(d,a);d.prototype.error=function(a){if(!this.isStopped){var e=void 0;try{e=this.selector(a,this.caught)}catch(d){this.destination.error(d);return}this._innerSub(e)}};d.prototype._innerSub=function(a){this.unsubscribe();this.destination.remove(this);a.subscribe(this.destination)};return d}(a.Subscriber)},{"../Subscriber":13}],199:[function(a,b,f){var h=a("./combineLatest");f.combineAll=function(a){return this.lift(new h.CombineLatestOperator(a))}},
{"./combineLatest":200}],200:[function(a,b,f){var h=this&&this.__extends||function(a,c){function e(){this.constructor=a}for(var d in c)c.hasOwnProperty(d)&&(a[d]=c[d]);a.prototype=null===c?Object.create(c):(e.prototype=c.prototype,new e)},k=a("../observable/ArrayObservable"),l=a("../util/isArray");b=a("../OuterSubscriber");var g=a("../util/subscribeToResult"),d={};f.combineLatest=function(){for(var a=[],e=0;e<arguments.length;e++)a[e-0]=arguments[e];e=null;"function"===typeof a[a.length-1]&&(e=a.pop());
1===a.length&&l.isArray(a[0])&&(a=a[0]);a.unshift(this);return(new k.ArrayObservable(a)).lift(new c(e))};var c=function(){function a(c){this.project=c}a.prototype.call=function(a,c){return c._subscribe(new e(a,this.project))};return a}();f.CombineLatestOperator=c;var e=function(a){function c(e,d){a.call(this,e);this.project=d;this.active=0;this.values=[];this.observables=[]}h(c,a);c.prototype._next=function(a){this.values.push(d);this.observables.push(a)};c.prototype._complete=function(){var a=this.observables,
c=a.length;if(0===c)this.destination.complete();else{this.toRespond=this.active=c;for(var e=0;e<c;e++){var d=a[e];this.add(g.subscribeToResult(this,d,d,e))}}};c.prototype.notifyComplete=function(a){0===--this.active&&this.destination.complete()};c.prototype.notifyNext=function(a,c,e,b,m){a=this.values;b=a[e];b=this.toRespond?b===d?--this.toRespond:this.toRespond:0;a[e]=c;0===b&&(this.project?this._tryProject(a):this.destination.next(a))};c.prototype._tryProject=function(a){var c;try{c=this.project.apply(this,
a)}catch(e){this.destination.error(e);return}this.destination.next(c)};return c}(b.OuterSubscriber);f.CombineLatestSubscriber=e},{"../OuterSubscriber":8,"../observable/ArrayObservable":142,"../util/isArray":322,"../util/subscribeToResult":332}],201:[function(a,b,f){function h(){for(var a=[],c=0;c<arguments.length;c++)a[c-0]=arguments[c];c=null;k.isScheduler(a[a.length-1])&&(c=a.pop());return(new l.ArrayObservable(a,c)).lift(new g.MergeAllOperator(1))}var k=a("../util/isScheduler"),l=a("../observable/ArrayObservable"),
g=a("./mergeAll");f.concat=function(){for(var a=[],c=0;c<arguments.length;c++)a[c-0]=arguments[c];return h.apply(void 0,[this].concat(a))};f.concatStatic=h},{"../observable/ArrayObservable":142,"../util/isScheduler":328,"./mergeAll":237}],202:[function(a,b,f){var h=a("./mergeAll");f.concatAll=function(){return this.lift(new h.MergeAllOperator(1))}},{"./mergeAll":237}],203:[function(a,b,f){var h=a("./mergeMap");f.concatMap=function(a,b){return this.lift(new h.MergeMapOperator(a,b,1))}},{"./mergeMap":238}],
204:[function(a,b,f){var h=a("./mergeMapTo");f.concatMapTo=function(a,b){return this.lift(new h.MergeMapToOperator(a,b,1))}},{"./mergeMapTo":239}],205:[function(a,b,f){var h=this&&this.__extends||function(a,d){function c(){this.constructor=a}for(var e in d)d.hasOwnProperty(e)&&(a[e]=d[e]);a.prototype=null===d?Object.create(d):(c.prototype=d.prototype,new c)};a=a("../Subscriber");f.count=function(a){return this.lift(new k(a,this))};var k=function(){function a(d,c){this.predicate=d;this.source=c}a.prototype.call=
...
return d}(a.Subscriber)},{"../Subscriber":13}],209:[function(a,b,f){var h=this&&this.__extends||function(a,c){function e(){this.constructor=a}for(var d in c)c.hasOwnProperty(d)&&(a[d]=c[d]);a.prototype=null===c?Object.create(c):(e.prototype=c.prototype,new e)},k=a("../scheduler/async"),l=a("../util/isDate");b=a("../Subscriber");var g=a("../Notification");f.delay=function(a,c){void 0===c&&(c=k.async);var e=l.isDate(a)?+a-c.now():Math.abs(a);return this.lift(new d(e,c))};var d=function(){function a(c,
...
(a[b]=e[b]);a.prototype=null===e?Object.create(e):(d.prototype=e.prototype,new d)};b=a("../Subscriber");var k=a("../util/tryCatch"),l=a("../util/errorObject");f.distinctUntilChanged=function(a,e){return this.lift(new g(a,e))};var g=function(){function a(c,d){this.compare=c;this.keySelector=d}a.prototype.call=function(a,c){return c._subscribe(new d(a,this.compare,this.keySelector))};return a}(),d=function(a){function e(e,d,b){a.call(this,e);this.keySelector=b;this.hasKey=!1;"function"===typeof d&&
...
"function"===typeof a?a:function(){return a});return b?new h.MulticastObservable(this,d,b):d}},{"../observable/ConnectableObservable":145,"../observable/MulticastObservable":157}],243:[function(a,b,f){var h=this&&this.__extends||function(a,e){function b(){this.constructor=a}for(var d in e)e.hasOwnProperty(d)&&(a[d]=e[d]);a.prototype=null===e?Object.create(e):(b.prototype=e.prototype,new b)};b=a("../Subscriber");var k=a("../Notification");f.observeOn=function(a,e){void 0===e&&(e=0);return this.lift(new l(a,
e))};var l=function(){function a(c,b){void 0===b&&(b=0);this.scheduler=c;this.delay=b}a.prototype.call=function(a,c){return c._subscribe(new g(a,this.scheduler,this.delay))};return a}();f.ObserveOnOperator=l;var g=function(a){function e(e,b,d){void 0===d&&(d=0);a.call(this,e);this.scheduler=b;this.delay=d}h(e,a);e.dispatch=function(a){a.notification.observe(a.destination)};e.prototype.scheduleMessage=function(a){this.add(this.scheduler.schedule(e.dispatch,this.delay,new d(a,this.destination)))};e.prototype._next=
...
l;try{l=f(a,c,b,d)}catch(h){g.error(h);return}g.next(l)};return c}(b.OuterSubscriber)},{"../OuterSubscriber":8,"../util/subscribeToResult":332}],270:[function(a,b,f){var h=this&&this.__extends||function(a,b){function d(){this.constructor=a}for(var f in b)b.hasOwnProperty(f)&&(a[f]=b[f]);a.prototype=null===b?Object.create(b):(d.prototype=b.prototype,new d)};b=a("../Subscriber");var k=a("../util/ArgumentOutOfRangeError"),l=a("../observable/EmptyObservable");f.take=function(a){return 0===a?new l.EmptyObservable:
...
h.onreadystatechange=null;e.removeChild(h);h=null};e.appendChild(h);return f};a.instance=this;return a};a.prototype.createSetTimeoutSetImmediate=function(){var a=function g(){var a=g.instance,b=a.addFromSetImmediateArguments(arguments);a.root.setTimeout(a.partiallyApplied(a.runIfPresent,b),0);return b};a.instance=this;return a};return a}();f.ImmediateDefinition=b;f.Immediate=new b(a.root)},{"./root":331}],315:[function(a,b,f){b=a("./root");a=a("./MapPolyfill");f.Map=b.root.Map||a.MapPolyfill},{"./MapPolyfill":316,
